                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="number" class="form-control" name="numCelular" required>
                                </div>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary" type="submit" name="submit" id="registar">Registrar persona</button>
                                </div>
